...
export const AdminSidebar = ({ active, onChange }: AdminSidebarProps) => (
  <aside className="rounded-3xl border border-[#ddb1cf] bg-[#f1e6f3] p-3 sm:p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_8px_18px_rgba(87,52,73,0.08)] md:sticky md:top-20">
    <nav className="flex gap-2 overflow-x-auto md:flex-col">
      {sections.map((section) => (
        <button
          ...
          className={cn(
            'rounded-2xl px-3 py-2 sm:px-4 sm:py-3 text-left text-sm font-semibold transition',
            active === section.id
